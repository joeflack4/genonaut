...
async def list_categories(
    ...
    """Get list of bookmark categories for a user with optional filtering."""
    service = BookmarkCategoryService(db)
    try:
...
async def delete_category(
    ...
    Note: Child categories will have their parent_id set to NULL (orphaned).
    Category memberships will be deleted by cascade.
    """
    service = BookmarkCategoryService(db)
    try:
